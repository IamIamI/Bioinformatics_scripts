...
# Example: python SSLIB_test_v003.py --input_file Sample.processed.bam --masking R --ref_file Reference.fasta --output_file Sample_RefGuidedmasked.bam
...
# Example: python SSLIB_test_v003.py --input_file Sample.processed.bam --masking H --output_file Sample_Hardmasked.bam
...
# Example: python SSLIB_test_v003.py --input_file Sample.processed.bam --masking E --edge_count 3 --output_file Sample_Edgemasked.bam
...
# Example: python SSLIB_test_v003.py --input_file Sample.processed.bam --output_file Sample_Hardmasked_Filtered.bam --mapq_cutoff 37 --len_cutoff 25
...
# python ../SSLIB_test_v003.py --input_file JUC013_libmerged.trimmed.bam --masking E --edge_count 3 --output_file JUC_DMG_Edgemasked.bam
